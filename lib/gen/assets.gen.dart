...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/bluemicrophon.png
  AssetGenImage get bluemicrophon =>
      const AssetGenImage('assets/icons/bluemicrophon.png');
...
class $AssetsImagesGen {
  ...
  /// List of all assets
  List<dynamic> get values => [avatar, logo, posterTest, techbot];
}
