...
class SolidColors {
  ...
  static const Color colorTitle = Color.fromARGB(255, 48, 107, 184);
  ...
  static const Color submitArticles = Color.fromARGB(255, 209, 209, 209);
...
class GradiantColors {
  static const List<Color> bottemNav = [
    Color.fromARGB(255, 25, 0, 94),
    Color.fromARGB(255, 68, 4, 87),
  ];
  static const List<Color> bottemNavBackground = [
